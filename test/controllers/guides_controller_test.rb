...
class GuidesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create guide" do
    assert_difference('Guide.count') do
      post guides_url, params: { guide: { description: @guide.description, item: @guide.item } }, as: :json
    end
  ...
  test "should update guide" do
    patch guide_url(@guide), params: { guide: { description: @guide.description, item: @guide.item } }, as: :json
    assert_response 200
  end
